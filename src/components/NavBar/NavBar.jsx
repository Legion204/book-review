            ...
            <div className="navbar-start">
                <div className="dropdown">
                    ...
                    <ul tabIndex={0} className="menu menu-sm dropdown-content mt-3 z-[1] p-2 shadow bg-base-100 rounded-box w-52 text-lg workSans text-[#131313CC]">
                        <NavLink className={({ isActive }) => isActive ? 'text-[#23BE0A] border-2 rounded-xl border-[#23BE0A]' : ''} to={'/'}><li><button>Home</button></li></NavLink>
                        <NavLink className={({ isActive }) => isActive ? 'text-[#23BE0A] border-2 rounded-xl border-[#23BE0A]' : ''} to={'/listed'}><li><button>Listed Books</button></li></NavLink>
                ...
                <NavLink to={'/'}><button className="btn btn-ghost font-bold text-xl md:text-3xl">Aura Library</button></NavLink>
            </div>
