...
const Author = ({ author }) => {
    ...
    const { author_name, book_name, occupation, author_image } = author;
    return (
        <section className="py-6 dark:bg-gray-100 dark:text-gray-800">
            <div className="container p-4 mx-auto space-y-16 sm:p-10">
                <div className="space-y-4">
                    <img alt="" className="object-fill w-80 h-64 mx-auto mb-4 bg-center rounded-3xl dark:bg-gray-500" src={author_image} />
                    <div className="flex flex-col items-center">
                        <h4 className="text-xl font-semibold">{author_name}</h4>
                        <p className="text-sm dark:text-gray-600 text-[#23BE0A]">{book_name}</p>
                        <p className="text-sm dark:text-gray-600">{occupation}</p>
